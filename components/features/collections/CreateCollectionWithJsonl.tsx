...
import { FileUp, PlusCircle, Trash2, Upload, X } from 'lucide-react';
...
export default function CreateCollectionWithJsonl() {
    ...
    const handleFileChange = async (
        ...
        if (selectedFile) {
            ...
            if (lines.length > 0) {
                ...
                setValue('fields', schema as unknown as FormData['fields']);
            }
        }
    };
    ...
    // The outer div ensures the modal content is scrollable and doesn't overflow
    return (
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Upload a JSONL file to define the schema for your
                            new Typesense collection.
                        </CardDescription>
                    </CardHeader>
                                                ...
                                                <div className="grid grid-cols-3 gap-4">
                                                    <div className="flex items-center space-x-2">
                                                        <Switch
                                                            ...
                                                            {...register(
                                                                `fields.${index}.facet` as const,
                                                            )}
                                                            disabled={isLoading}
                                                        />
                                                        <Label
                                                            htmlFor={`fields.${index}.facet`}
                                                        >
                                                            Facet
                                                        </Label>
                                                    </div>
                                                    <div className="flex items-center space-x-2">
                                                        <Switch
                                                            ...
                                                            {...register(
                                                                `fields.${index}.index` as const,
                                                            )}
                                                            disabled={isLoading}
                                                        />
                                                        <Label
                                                            htmlFor={`fields.${index}.index`}
                                                        >
                                                            Index
                                                        </Label>
                                                    </div>
                                                    <div className="flex items-center space-x-2">
                                                        <Switch
                                                            ...
                                                            {...register(
                                                                `fields.${index}.optional` as const,
                                                            )}
                                                            disabled={isLoading}
                                                        />
                                                        <Label
                                                            htmlFor={`fields.${index}.optional`}
                                                        >
                                                            Optional
                                                        </Label>
                                                    </div>
                                                    <div className="flex items-center space-x-2">
                                                        <Switch
                                                            ...
                                                            {...register(
                                                                `fields.${index}.sort` as const,
                                                            )}
                                                            disabled={isLoading}
                                                        />
                                                        <Label
                                                            htmlFor={`fields.${index}.sort`}
                                                        >
                                                            Sort
                                                        </Label>
                                                    </div>
