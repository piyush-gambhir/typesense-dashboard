                    ...
                    <div className="text-center mb-12">
                        ...
                        <div className="max-w-3xl mx-auto">
                            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                                ...
                                and monitor performance with a beautiful,
                                intuitive interface designed for developers and
                                administrators.
                            </p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                                <div className="text-center p-6 rounded-xl bg-card/50 border border-border/50">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Create, update, and manage your search
                                ...
                                <div className="text-center p-6 rounded-xl bg-card/50 border border-border/50">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Monitor search performance and user
                                        behavior patterns
                                    </p>
                                </div>
                                ...
                                <div className="text-center p-6 rounded-xl bg-card/50 border border-border/50">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Track cluster health and system
