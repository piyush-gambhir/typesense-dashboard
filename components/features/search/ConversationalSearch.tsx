...
export default function ConversationalSearch({
    ...
    const loadConversationMessages = async (conv: Conversation) => {
        try {
            ...
            if (result.success && result.data) {
                const chatMessages: ChatMessage[] = result.data.messages.map(
                    (msg, index) => ({
                        ...msg,
                        id: `${conv.id}-${index}`,
                    }),
        ...
        try {
            ...
            if (searchResult.success && searchResult.data) {
                const assistantMessage: ChatMessage = {
                    ...
                    timestamp: Date.now(),
                    searchResults:
                        searchResult.data.search_results.hits?.map(
                            (hit) => hit.document,
                        ) || [],
                ...
                toast({
                    title: 'Search Failed',
                    description:
                        searchResult.error || 'Failed to perform search.',
                    variant: 'destructive',
                });
            }
        } catch {
    ...
    const clearConversation = () => {
        ...
        onConversationChange?.(null as any);
    };
                    ...
                    >
                        ...
                        <DialogContent>
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Configure your conversational search
                                    preferences
                                </DialogDescription>
                            </DialogHeader>
                    ...
                    {messages.length === 0 ? (
                        <div className="flex flex-col items-center justify-center h-full text-center py-12">
                            ...
                            <p className="text-muted-foreground mb-4 max-w-md">
                                Ask questions about your {collectionName}{' '}
                                collection using natural language. The AI will
                                help you find and understand your data.
                            </p>
                            <Badge variant="outline">
                                Try: &quot;Show me recent documents&quot; or
