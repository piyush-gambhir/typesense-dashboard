      ...
      <Card className="border-none shadow-none">
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle>Natural Language Search Models</CardTitle>
              <CardDescription>
            ...
            <div className="flex items-center justify-center h-64">
              <div className="text-center space-y-6 max-w-md">
                ...
                <div className="space-y-2">
                  <h3 className="text-xl font-semibold">No NL Search Models</h3>
                ...
                {models.map((model) => {
                  ...
                  return (
                    <TableRow key={model.id}>
                      ...
                      <TableCell>
                        {model.temperature !== undefined ? model.temperature : 'N/A'}
                      </TableCell>
                      <TableCell>
                        {model.max_bytes ? `${model.max_bytes.toLocaleString()}` : 'N/A'}
                      </TableCell>
                      <TableCell>
