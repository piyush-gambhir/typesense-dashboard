...
export default function CreateCollectionUnified({ 
    ...
    const handleFileChange = async (
        ...
        if (selectedFile) {
            if (selectedFile.type !== 'application/json' && !selectedFile.name.endsWith('.jsonl')) {
                toast({
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                            <div className="flex items-center space-x-2">
                                ...
                                />
                                <Label htmlFor={`field-${index}-facet`} className="text-sm">
                                    Facet
                                </Label>
                            </div>
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                />
                                <Label htmlFor={`field-${index}-index`} className="text-sm">
                                    Index
                                </Label>
                            </div>
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                />
                                <Label htmlFor={`field-${index}-optional`} className="text-sm">
                                    Optional
                                </Label>
                            </div>
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                />
                                <Label htmlFor={`field-${index}-sort`} className="text-sm">
                                    Sort
                                </Label>
                            </div>
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                />
                                <Label htmlFor={`field-${index}-store`} className="text-sm">
                                    Store
                                </Label>
                            </div>
                        </div>
    ...
    const renderAdvancedOptions = () => (
        <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <Label htmlFor="default-sorting-field">Default Sorting Field</Label>
                    <Controller
                            ...
                            <Select value={field.value || ''} onValueChange={field.onChange}>
                                ...
                                <SelectContent>
                                    {sortableFields.map((sortField) => (
                                        <SelectItem key={sortField.name} value={sortField.name}>
                                            {sortField.name}
                                        </SelectItem>
                                    ))}
                                </SelectContent>
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex justify-end gap-2">
                ...
                >
                    {isCreating || isLoading ? 'Creating...' : 'Create Collection'}
                </Button>
            </div>
        </form>
    );
