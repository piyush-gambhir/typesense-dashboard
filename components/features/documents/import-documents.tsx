            ...
            <Card className="border border-border/50 shadow-sm">
                <CardHeader className="space-y-1">
                    ...
                    <CardDescription className="text-muted-foreground">
                        Upload JSON, JSONL, or CSV files to import documents
                                        ...
                                        [
                                            {
                                                ...
                                                label: 'Create',
                                                description:
                                                    'Only create new documents (fail if exists)',
                                            },
                                            {
                                                value: 'update',
                                                label: 'Update',
                                                description:
                                                    'Only update existing documents (fail if not exists)',
                                            },
                                            {
                                                value: 'upsert',
                                                label: 'Upsert',
                ...
                <CardFooter className="flex flex-col space-y-4 pt-6">
                    ...
                    {importLog.length > 0 && (
                        <div className="text-xs text-muted-foreground text-center">
                            Import log contains {importLog.length} entries with
                            detailed results
                        </div>
                    )}
                </CardFooter>
