        ...
        <div className="container h-full overflow-hidden mx-auto">
            <Card className="h-full flex flex-col border-none shadow-none">
                <CardHeader>
                    ...
                    <CardDescription>
                        Manage your Typesense API keys
                    </CardDescription>
                </CardHeader>
                    ...
                    <ScrollArea className="h-full">
                        {apiKeys.length === 0 ? (
                            <div className="text-center py-8 text-muted-foreground">
                                No API keys available. Create one to get
                                started.
                            </div>
                        ) : (
                            <Table>
                    ...
                    >
                        ...
                        <DialogContent className="sm:max-w-[425px] max-h-[90vh] overflow-hidden flex flex-col">
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Create a new API key with specific
                                    permissions.
                                </DialogDescription>
                            </DialogHeader>
                                            ...
                                            {availableCollections.map(
                                                (collection) => (
                                                    ...
                                                    >
                                                        <Checkbox
                                                            id={collection}
                                                            checked={newKeyCollections.includes(
                                                                collection,
                                                            )}
                                                            onCheckedChange={(
                                                                checked,
                                        ...
                                        <div className="col-span-3 space-y-2">
                                            {availableActions.map((action) => (
                                                ...
                                                >
                                                    <Checkbox
                                                        id={action}
                                                        checked={newKeyActions.includes(
                                                            action,
                                                        )}
                                                        onCheckedChange={(
                                                            checked,
