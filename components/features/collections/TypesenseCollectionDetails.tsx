...
import { ArrowRightFromLineIcon, Import, PlusCircle } from 'lucide-react';
        ...
        <div className="container mx-auto p-4 sm:p-6 lg:p-8 flex flex-col gap-y-6 lg:gap-y-8">
                        ...
                        <div>
                            ...
                            <dd className="mt-1">
                                <Select
                                    ...
                                    onValueChange={
                                        handleDefaultSortingFieldChange
                                    }
                                >
            ...
            <div className="flex flex-col lg:flex-row gap-4 lg:justify-between lg:items-center">
                <div className="flex flex-wrap gap-3">
                    ...
                    <Button onClick={handleImportDocuments} variant="outline">
                        <Import className="w-4 h-4 mr-2" />
                        Import Documents
                    </Button>
                    <Button onClick={handleExportDocuments} variant="outline">
                ...
                <CardContent>
                    <div className="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-md">
                        <p className="text-sm text-yellow-800">
                            <strong>Note:</strong> Typesense only allows adding
                            new fields to existing collections. You cannot
                            modify field types, delete existing fields, or
                            change existing field properties. If you need to
                            change field properties, you&apos;ll need to
