...
import { createAnalyticsRule, deleteAnalyticsRule, listAnalyticsRules } from '@/lib/typesense/analytics-rules';
...
export default function AnalyticsRules() {
  ...
  const handleCreateRule = async () => {
    ...
    try {
      ...
      toast({
        title: 'Error',
        description: error?.message || 'Failed to create analytics rule',
        variant: 'destructive',
      });
    } finally {
      setIsCreating(false);
  ...
  const handleDeleteRule = async () => {
    ...
    try {
      ...
      toast({
        title: 'Error',
        description: error?.message || 'Failed to delete analytics rule',
        variant: 'destructive',
      });
    } finally {
    ...
    <div className="container mx-auto p-8 flex flex-col gap-y-8">
      <Card className="shadow-none">
        <CardHeader>
          ...
          <CardDescription>Manage your Typesense analytics rules.</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
        ...
        <CardFooter>
          <Dialog>
            ...
            <DialogContent className="sm:max-w-2xl">
              <DialogHeader>
                <DialogTitle>Create New Analytics Rule</DialogTitle>
                <DialogDescription>
                  Create a new analytics rule by providing a name and JSON definition.
                </DialogDescription>
              </DialogHeader>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              analytics rule <span className="font-bold">{ruleToDelete}</span>.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
