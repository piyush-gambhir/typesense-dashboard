...
export default function Stopwords() {
    ...
    const [stopwordsToDelete, setStopwordsToDelete] =
        useState<StopwordsSet | null>(null);
    ...
    const fetchStopwords = async (collectionName: string) => {
        ...
        try {
            ...
            if (fetchedStopwords) {
                setStopwordsSets([
                    { id: 'default', stopwords: fetchedStopwords },
                ]);
            } else {
                setStopwordsSets([]);
            }
    ...
    const handleCreateStopwords = async () => {
        if (
            ...
            toast({
                ...
                description:
                    'Please provide stopwords ID, stopwords list, and select a collection.',
                variant: 'destructive',
            });
            return;
        }

        const stopwordsArray = newStopwords
            .split(',')
            .map((word) => word.trim())
            .filter((word) => word);
        ...
        setIsCreating(true);
        try {
            const created = await upsertStopwords(
                selectedCollection,
                newStopwordsId,
                {
            ...
            toast({
                ...
                description:
                    error instanceof Error
                        ? error.message
                        : 'Failed to create stopwords set',
                variant: 'destructive',
            });
        } finally {
            setIsCreating(false);
    ...
    const handleDeleteStopwords = async () => {
        ...
        try {
            const deleted = await deleteStopwords(
                selectedCollection,
                stopwordsToDelete.id,
            );
            if (deleted) {
                toast({
            ...
            toast({
                ...
                description:
                    error instanceof Error
                        ? error.message
                        : 'Failed to delete stopwords set',
                variant: 'destructive',
            });
        } finally {
        ...
        <div className="container mx-auto p-8 flex flex-col gap-y-8">
            <Card className="shadow-none">
                <CardHeader>
                    ...
                    <CardDescription>
                        Manage stopwords for your Typesense collections.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="mb-6">
                            ...
                            <TableBody>
                                {stopwordsSets.length === 0 ? (
                                    <TableRow>
                                        ...
                                        >
                                            No stopwords sets found for this
                                            collection.
                                        </TableCell>
                                    </TableRow>
                                ) : (
                    ...
                    <Dialog>
                        ...
                        <DialogContent>
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Create a new stopwords set for the selected
                                    collection.
                                </DialogDescription>
                            </DialogHeader>
                            <div className="grid gap-4 py-4">
                                <div className="grid grid-cols-4 items-center gap-4">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            setNewStopwordsId(e.target.value)
                                        }
                                ...
                                <div className="grid grid-cols-4 items-center gap-4">
                                    ...
                                    <Textarea
                                        ...
                                        value={newStopwords}
                                        onChange={(e) =>
                                            setNewStopwords(e.target.value)
                                        }
                                        className="col-span-3"
