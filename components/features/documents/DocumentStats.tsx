...
export default function DocumentStats({
    ...
    return (
        <div className="space-y-8">
            {/* Header */}
            <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tight">Collection Statistics</h1>
                <p className="text-muted-foreground">
                    Detailed insights and analytics for the {collectionName} collection
                </p>
            </div>
            ...
            <Card className="border border-border/50 shadow-sm">
                <CardHeader className="space-y-1">
                    <div className="flex items-center gap-2">
                        ...
                        <CardTitle className="text-xl font-semibold">Field Analytics</CardTitle>
                    </div>
                    <CardDescription className="text-muted-foreground">
                        Deep dive into field distributions, value patterns, and data quality metrics
                    </CardDescription>
                </CardHeader>
                                    ...
                                    >
                                        <div className="flex flex-col">
                                            ...
                                            <span className="text-xs text-muted-foreground">
                                                {field.type} {field.facet ? '• Facetable' : ''} {field.sort ? '• Sortable' : ''}
                                            </span>
                                        </div>
                                    </SelectItem>
                                ))}
                                            ...
                                            .map((key) => (
                                                ...
                                                >
                                                    ...
                                                    <span className="text-sm text-foreground flex-1 min-w-0">
                                                        {String(doc[key]).substring(0, 100)}
                                                        {String(doc[key]).length > 100 ? '...' : ''}
                                                    </span>
                                                </div>
                                            ))}
                                    </div>
