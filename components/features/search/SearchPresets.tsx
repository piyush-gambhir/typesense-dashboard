...
export default function SearchPresets() {
    ...
    const [overrideToDelete, setOverrideToDelete] =
        useState<SearchOverride | null>(null);
    ...
    const fetchOverrides = async () => {
        try {
            ...
            toast({
                title: 'Error',
                description: 'Failed to load search presets.',
                variant: 'destructive',
            });
        }
    };
        ...
        <div className="container mx-auto p-8 flex flex-col gap-y-8">
            <Card className="shadow-none">
                <CardHeader>
                    ...
                    <CardDescription>
                        Manage your Typesense search overrides.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <Table>
                ...
                <CardFooter>
                    <Dialog>
                        ...
                        <DialogContent className="sm:max-w-2xl">
                            <DialogHeader>
                                <DialogTitle>
                                    Create New Search Override
                                </DialogTitle>
                                <DialogDescription>
                                    Create a new search override for a
                                    collection.
                                </DialogDescription>
                            </DialogHeader>
                            <div className="grid gap-4 py-4">
                                <div className="grid grid-cols-4 items-center gap-4">
                                    ...
                                    <Input
                                        ...
                                        value={newOverrideId}
                                        onChange={(e) =>
                                            setNewOverrideId(e.target.value)
                                        }
                                ...
                                <div className="grid grid-cols-4 items-center gap-4">
                                    ...
                                    <Textarea
                                        ...
                                        onChange={(e) =>
                                            setNewOverrideRule(e.target.value)
                                        }
