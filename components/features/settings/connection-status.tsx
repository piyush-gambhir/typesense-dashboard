        ...
        <div className="space-y-8">
                            ...
                            <Alert variant="destructive">
                                ...
                                <AlertDescription className="mt-2">
                                    <div className="space-y-2">
                                        ...
                                        {!allEnvVarsSet && (
                                            <p className="text-sm">
                                                Some required environment
                                                variables are missing. Check the
                                                configuration below.
                                            </p>
                                        )}
                                    </div>
            ...
            <Card className="border border-border/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Status of required environment variables for Typesense
                        connection
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    ...
                    {!allEnvVarsSet && (
                        <Alert>
                            ...
                            <AlertDescription>
                                Some environment variables are missing. Please
                                set all required variables and restart your
