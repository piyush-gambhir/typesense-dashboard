        ...
        <Card className="border border-border/50">
            ...
            <CardContent className="space-y-6">
                <Alert>
                    ...
                    <AlertDescription>
                        <strong>Schema Limitations:</strong> Typesense only
                        allows adding new fields to existing collections. You
                        cannot modify field types, delete existing fields, or
                        change existing field properties. To change field
                        properties, you'll need to recreate the collection.
                    </AlertDescription>
                </Alert>
                {isJsonMode ? (
