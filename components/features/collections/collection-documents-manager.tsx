...
import ImportDocuments from '@/components/features/documents/import-documents';

interface CollectionDocumentsManagerProps {
    collectionName: string;
}

export default function CollectionDocumentsManager({
    collectionName,
}: CollectionDocumentsManagerProps) {
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Manage documents in collection '{collectionName}'
                        </p>
                    </div>
                </div>
            </div>
                ...
                <Card className="border border-border/50 hover:shadow-md transition-shadow">
                    ...
                    <CardContent>
                        <p className="text-sm text-muted-foreground">
                            Upload JSON, CSV, or JSONL files to add documents to
                            your collection
                        </p>
                    </CardContent>
                </Card>
