    ...
    const renderContent = () => {
        ...
        if (typeof value === 'string') {
            ...
            try {
                ...
                return (
                    <div className="flex items-center gap-2">
                        <div className="text-sm break-words font-mono bg-muted/30 rounded-md p-2 flex-1">
                            {value.length > 200
        ...
        if (field.toLowerCase() === 'id') {
            return (
                <div className="flex items-center gap-2">
                    <div className="text-sm font-mono bg-muted/30 rounded-md p-2 flex-1">
                        {String(value)}
                    </div>
                    <Button
                        variant="ghost"
                    ...
                    <div className="my-4 p-4 bg-destructive/5 border border-destructive/20 rounded-lg">
                        <div className="space-y-2">
                            ...
                            <p className="text-sm text-muted-foreground">
                                This action cannot be undone. The document and
                                all its data will be permanently removed.
                            </p>
                        </div>
                    </div>
