        ...
        <div className="container mx-auto px-4 py-8 space-y-8">
            ...
            <div className="flex items-center justify-between">
                <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                        Manage your Typesense server configuration and
                        connection settings
                    </p>
                </div>
            </div>
            ...
            <Card className="border border-border/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Typesense connection is configured via environment
                    ...
                    <div className="p-6 bg-muted/30 border border-border/50 rounded-lg">
                        <div className="space-y-4">
                            ...
                            <p className="text-sm text-muted-foreground leading-relaxed">
                                ...
                                secure environment variables. These settings are
                                loaded server-side and never exposed to the
                                client.
                            </p>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                {[
                                    ...
                                    <div
                                        key={item.var}
                                        className="p-4 bg-background/60 border border-border/50 rounded-lg"
                                    >
                                        <div className="space-y-2">
                        ...
                        <div className="flex gap-3">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-xs text-blue-700 dark:text-blue-300 leading-relaxed">
                                    Environment variables ensure your Typesense
                                    credentials are never exposed in client-side
                                    code. Make sure to restart your application
